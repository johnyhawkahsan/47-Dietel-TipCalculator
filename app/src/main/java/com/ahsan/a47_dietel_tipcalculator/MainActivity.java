...
package com.ahsan.a47_dietel_tipcalculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void calculate() {
        ...
        double tip = billAmount * percent;  //This is a new variable
        double total = billAmount + tip;    //This is a new variable
    ...
    private final TextWatcher amountEditTextWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            try {
                ...
                billAmount = Double.parseDouble(s.toString()) / 100.0;//NOTE: Dividing what we enter with 100.0 gives us values in points in the beginning.
                amountTextView.setText(currencyFormat.format(billAmount));//Set value in this TExtView according to whats been entered in AmountEditText
            }
            ...
            // update the tip and total TextViews
            calculate();
        }
